...
$(document).ready(function(){
 ...
 $(".bodym>form>fieldset>input[type='text']").focus();}
   ...
   if($('#rcpwd').val()!=$('#rpwd').val()) {   
    ...
    //college
        else if( $('.form>select[name=College]').val()==null )
            {
                $('.rmsg').text("Select Your College").animate({opacity:'1'});
                mha=false; 
            }
    //email
        ...
        if(mha==true)
            {
                    ...
                    $('.reg').css('width','50%');
                    $('.reg').css('border-radius','15px 15px 0px 0px')            
                
                
            
        $('#hello').click(function(){
            $('.form:nth-child(2)').animate({marginLeft:'-110%'});
                    $('.form:nth-child(3)').animate({marginLeft:'0px'});
            $('.btn').css({opacity:'1'});
                    $('.btn').css('cursor','pointer');
                    $('.reg').css('width','40%');
                    $('.reg').css('border-radius','15px 0px 0px 0px')});}
    }
            else if(iiu==1)
                  {
